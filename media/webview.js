(function () {
  ...
  function render() {
        ...
        <main class="reader">
          <div class="reader-toolbar">
            ...
            <div class="toolbar-actions">
              <button class="action-button secondary-button show-course" type="button">Show Course</button>
              <button class="action-button secondary-button previous-chapter" type="button">Previous</button>
              <button class="action-button secondary-button mark-complete" type="button">Mark Complete</button>
    ...
    app.querySelector('.mark-complete').addEventListener('click', toggleComplete);
  ...
  function renderCurrentChapter() {
    ...
    const completeButton = app.querySelector('.mark-complete');
    const completed = state.completedChapters.includes(chapter.number);
  ...
  function toggleComplete() {
    ...
    if (completed.has(currentChapterNumber)) {
      completed.delete(currentChapterNumber);
    } else {
      completed.add(currentChapterNumber);
    }
